...
document
  .querySelectorAll(".app-card, .large-app-card, .install-button")
  .forEach((element) => {
...
function openApp(appName) {
  ...
  switch (appName) {
    ...
    case "mypdf":
      ...
      url = "https://mypdf.inled.es/";
      break;
    case "office":
      // Replace with the actual URL for Start Omnibox
      url = "https://office.inled.es/"; // Example for a browser extension
      break;
    case "inled":
      // Replace with the actual URL for Start Omnibox
      url = "https://inled.es/"; // Example for a browser extension
      break;
    default:
      alert(
        "Error. No se encuentra el enlace al servicio. Visite inled.es",
        appName,
      );
